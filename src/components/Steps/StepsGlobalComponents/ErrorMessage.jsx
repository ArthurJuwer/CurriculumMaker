...
export default function ErrorMessage({message, onClose}){
      return(
        <div className={`${!message ? 'hidden' : 'flex' } xl:w-1/4 xl:min-w-1/4 w-11/12 absolute top-16 left-1/2 transform -translate-x-1/2 items-center justify-between p-4 rounded-3xl shadow-2xl bg-[#ECC8C5] z-50`}>
