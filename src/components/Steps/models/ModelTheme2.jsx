                ...
                {valuesCurriculum?.projects?.map((item, index) => (
                  <div key={`project-${index}`}>
                    <div className="flex gap-x-2 items-center">
                      <p className="2xl:text-p1920Model lg:text-p1920ModelXL text-p1920ModelMD">
                        {item?.year} -
                      </p>
                      <p className="text-TitleGray 2xl:text-p1920Model lg:text-p1920ModelXL text-p1920ModelMD">
                        {item?.title} | {item?.category}
                      </p>
                    </div>
                    <p className="text-WeakGray 2xl:text-p1920Model lg:text-p1920ModelXL text-p1920ModelMD">
                      {item?.description}
                    </p>
                  </div>
                ))}
              ...
              {valuesCurriculum?.formations?.map((item, index) => (
                <ul key={`formation-${index}`} className="pb-2">
                  <div className="flex items-center gap-x-4">
                    <li className="text-TitleGray 2xl:text-p1920Model lg:text-p1920ModelXL text-p1920ModelMD flex items-center">
                      • {item?.school}
                    </li>
                  </div>
                  <li className="text-TitleGray 2xl:text-p1920Model lg:text-p1920ModelXL text-p1920ModelMD">
          ...
          {valuesCurriculum?.languages && (
            <div>
              <h1
                ...
                style={{
                  borderColor: `#${valuesCurriculum?.color}`,
                  fontSize: valuesCurriculum?.textSubTitle,
                }}
              >
                Idiomas
              </h1>
