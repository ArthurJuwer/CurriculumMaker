...
export default function ModelsView() {
  ...
  return (
    <div className="h-dvh w-full overflow-hidden bg-DefaultGray flex flex-col 2xl:py-16 lg:py-14 py-4 items-center 2xl:gap-y-8 lg:gap-y-3 gap-y-1">
      <h1 className="text-StrongGray text-center font-bold 2xl:text-4xl xl:text-3xl text-base lg:text-2xl lg:w-1/3 w-11/12 mt-10 lg:mt-0">
      ...
      {isMd ? (
        ...
        <div className="w-full flex-1 min-h-0 flex flex-col items-center gap-y-1.5">
          <div
            ref={sliderRef}
