...
export default function SelectMethodView() {
  ...
  const methodOptions = [
    {
      ...
      text: "Nós iremos pegar os dados antigos que você escreveu e preencher todos os campos deixando você modificar os antigos dados",
      icon: <RotateCcw width={35} height={35} />,
    },
    {
      id: "new",
      title: "Novo Currículo",
      text: "Nós iremos pegar os dados antigos que você escreveu e preencher todos os campos deixando você modificar os antigos dados",
      icon: <Plus width={35} height={35} />,
    },
  ];
  ...
  return (
    <div className="w-full h-dvh bg-DefaultGray flex flex-col justify-center items-center 2xl:gap-y-40 xl:gap-y-24 gap-y-16">
      <div className="flex flex-col justify-center items-center text-center 2xl:gap-y-28 xl:gap-y-12 gap-y-8">
        <h1 className="font-bold 2xl:text-5xl xl:text-4xl lg:text-3xl text-2xl lg:tracking-wide tracking-normal text-StrongGray lg:w-5/12 w-8/12">
          Carregar Dados Salvos Recentemente
        </h1>
        <div className="2xl:w-7/12 xl:w-9/12 lg:w-10/12 w-11/12 flex flex-col lg:flex-row items-center justify-center lg:gap-x-12 gap-y-4 lg:gap-y-0">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-8 rounded-xl lg:w-4/12 w-11/12 flex flex-col gap-y-8 relative">
            ...
            <p>
              Tem certeza de que deseja excluir este currículo? Uma vez excluído, este currículo
